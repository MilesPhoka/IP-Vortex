...
# Version 1.2
# Author: Miles Phoka
# GitHub: https://github.com/MilesPhoka/ip-vortex
...
display_banner() {
    echo -e "\e[34m"
    echo "  _____ _____   ____   _____ _______ ______ _____  "
    echo " |_   _|  __ \ / __ \ / ____|__   __|  ____|  __ \ "
    echo "   | | | |__) | |  | | (___    | |  | |__  | |__) |"
    echo "   | | |  ___/| |  | |\___ \   | |  |  __| |  _  / "
    echo "  _| |_| |    | |__| |____) |  | |  | |____| | \ \ "
    echo " |_____|_|     \____/|_____/   |_|  |______|_|  \_\\"
    echo -e "\e[0m"
    echo "IP Vortex v1.2 - Cycle Through IPs Like a Digital Ghost"
    echo "Created by Miles Phoka"
    echo "======================================================="
    echo
}
...
check_updates() {
    ...
    latest_version=$(curl -s https://raw.githubusercontent.com/MilesPhoka/ip-vortex/main/version.txt)
    if [[ "$latest_version" != "1.2" ]]; then
        echo -e "\e[33m[!] Update available! Version $latest_version is available.\e[0m"
        echo -e "Run: git pull https://github.com/MilesPhoka/ip-vortex.git"
    else
